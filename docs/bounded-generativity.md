...
- **ASK advisory / extended-cognition workflows** — an operator-authored source of intent opens the aperture; AI advisors, external readers, source texts, and critique loops supply candidate distinctions, objections, evidence, and formulations; the operator selects, rejects, revises, or closes what becomes durable in a master note, repo doc, tracker, article, or closure memo. The middle span supplies real value **without owning admission into the standard**: the bounded-generativity structure lies in the authored aperture and the judgment closure — the source of intent sets the grammar and remains answerable for what it admits, while the generative / advisory middle fills the aperture. The instance shows the primitive governing a *cognition* loop, not only artifact production.
